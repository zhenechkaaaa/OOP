...
public class CourseConfigLexer extends Lexer {
	...
	private static String[] makeRuleNames() {
		return new String[] {
			...
			"T__17", "T__18", "T__19", "T__20", "T__21", "T__22", "GRADE", "ID", 
			"STRING", "NUMBER", "BOOLEAN", "WS", "COMMENT", "LINE_COMMENT"
		};
	}
	...
	public CourseConfigLexer(CharStream input) {
		super(input);
